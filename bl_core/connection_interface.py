...
def send_data_from_chatbot():
    ...
    parsed_message = parse_bot_response(msg)
...
if __name__ == '__main__':
    ...
    userTrack.start()
    http_server = WSGIServer((host,port), wsgi_app, handler_class=WebSocketHandler, keyfile="server_1.key", certfile='server_1.cert')
