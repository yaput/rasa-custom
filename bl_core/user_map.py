...
with open('./data/%s/database/master/response.json' % config["template"]["module"], encoding="utf-8", errors='ignore') as temp:
    template_message = json.load(temp,format="utf-8")
